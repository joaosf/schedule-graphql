...
describe('taskResolvers', () => {
  ...
  describe('Query: task', () => {
    it('should fetch a task by ID', async () => {
      const mockTask: TaskModel = { id: 'task-1', accountId: 1, scheduleId: 'sched-1', startTime: new Date(), duration: 60, type: 'work' };
  ...
  describe('Mutation: deleteTask', () => {
    it('should delete a task by ID', async () => {
      const mockDeletedTask: TaskModel = { id: 'task-1', accountId: 1, scheduleId: 'sched-1', startTime: new Date(), duration: 60, type: 'work' };
